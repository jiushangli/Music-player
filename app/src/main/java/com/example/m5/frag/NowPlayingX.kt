...
import com.example.m5.databinding.FragmentNowPlayingxBinding
...
class NowPlayingX : Fragment() {
    companion object {
        @Suppress("StaticFieldLeak")
        lateinit var binding: FragmentNowPlayingxBinding
    }
    ...
    override fun onCreateView(
        ...
        binding = FragmentNowPlayingxBinding.bind(view)
